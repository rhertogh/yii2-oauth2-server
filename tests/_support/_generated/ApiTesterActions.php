<?php  //[STAMP] 28c4af92eff4e514f61051ad2dd76033
namespace Yii2Oauth2ServerTests\_generated;
...
trait ApiTesterActions
{
     ...
     * @part json
     * @part xml
     * @see \Yii2Oauth2ServerTests\Oauth2REST::grabHttpHeaders()
     */
    public function grabHttpHeaders() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabHttpHeaders', func_get_args()));
    }
     ...
     * @part json
     * @part xml
     * @see \Yii2Oauth2ServerTests\Oauth2REST::grabStatusCode()
     */
    public function grabStatusCode() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabStatusCode', func_get_args()));
    }
     ...
     * @param $fixtures
     * @part fixtures
     * @see \Yii2Oauth2ServerTests\Helper\Yii2Module::haveFixtures()
     */
